...
public class IOTSavePhantomTokenToServerModel extends BaseRequestModel<LingResultEntity> {

    public IOTSavePhantomTokenToServerModel(IRequestCallback requestCallback) {
